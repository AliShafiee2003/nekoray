...
DialogBasicSettings::DialogBasicSettings(QWidget *parent)
    ...
    if (ui->inbound_address->text().isEmpty() || ui->inbound_address->text() == "::") {
        ui->inbound_address->setText("127.0.0.1");
    }
...
void DialogBasicSettings::accept() {
    ...
    ui->inbound_address->setText(ui->inbound_address->text().trimmed());
    if (ui->inbound_address->text().isEmpty() || ui->inbound_address->text() == "::") {
        ui->inbound_address->setText("127.0.0.1");
    }
